...
//Homework : hw01
//Program :
//bu program game of life oyununu simule eden bir programdır.
...
//Canlı hücre sayısını hesaplama
int findAliveCell(char**arr,int rowSize,int colSize){
